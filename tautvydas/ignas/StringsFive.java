...
public class StringsFive {
    public static void main(String[] args) {
        ...
        //2nd occurence ???
        int x = s.indexOf('d');             // atrandame pirmaja raide d
        int y = s.indexOf('d', x + 1);    // atrandame antraja raide d, kuri yra toliau nuo pirmosios.
        ...
        System.out.println("Letter d occurred: " + count);     // suskaičiuoja kiek kartų pasikartojo raidė.
